...
void OpenCrypto_OT_encrypt(struct OpenCrypto_OT_public_parameters pp, struct OpenCrypto_OT_sender_keys sender, int public_key_receiver, const byte** messages, unsigned int number_messages, const byte** out_ciphers) {
...
void OpenCrypto_OT_decrypt(struct OpenCrypto_OT_receiver_keys receiver, const byte** ciphers, int number_ciphers, const byte** out_messages) {
